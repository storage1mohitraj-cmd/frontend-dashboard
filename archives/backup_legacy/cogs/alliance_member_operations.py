...
try:
    ...
    from admin_utils import is_admin, is_global_admin, get_admin, upsert_admin, format_furnace_level
except ImportError:
...
class PaginationView(discord.ui.View):
    ...
    async def _handle_page_change(self, interaction: discord.ApplicationContext, change: int):
    ...
    async def update_page(self, interaction: discord.ApplicationContext):
...
class AllianceMemberOperations(commands.Cog):
    ...
    async def handle_member_operations(self, interaction: discord.ApplicationContext):
        embed = discord.Embed(
        ...
        class MemberOperationsView(discord.ui.View):
            ...
            async def add_member_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
            ...
            async def remove_member_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                await button_interaction.response.defer(ephemeral=True)
                try:
                    admin_info = get_admin(button_interaction.user.id)
                    ...
                    async def select_callback(interaction: discord.ApplicationContext):
                        ...
                        async def member_callback(member_interaction: discord.ApplicationContext):
                            ...
                            if selected_value == "all":
                                ...
                                async def confirm_single_callback(confirm_interaction: discord.ApplicationContext):
            ...
            async def view_members_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                await button_interaction.response.defer(ephemeral=True)
                try:
                    admin_info = get_admin(button_interaction.user.id)
            ...
            async def transfer_member_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                await button_interaction.response.defer(ephemeral=True)
                try:
                    admin_info = get_admin(button_interaction.user.id)
                    ...
                    async def source_callback(interaction: discord.ApplicationContext):
                        try:
                            ...
                            async def member_callback(member_interaction: discord.ApplicationContext):
                                ...
                                async def target_callback(target_interaction: discord.ApplicationContext):
    ...
    async def add_user(self, interaction: discord.ApplicationContext, alliance_id: str, ids: str):
    ...
    async def _process_add_user(self, interaction: discord.ApplicationContext, alliance_id: str, alliance_name: str, ids: str):
...
class AllianceSelectView(discord.ui.View):
    ...
    async def fid_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
...
def setup(bot):
    bot.add_cog(AllianceMemberOperations(bot))
