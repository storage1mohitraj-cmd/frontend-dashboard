...
class AttendanceSettingsView(discord.ui.View):
    ...
    async def report_type_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def back_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
...
class ReportTypeSelectView(discord.ui.View):
    ...
    async def text_reports_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def matplotlib_reports_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def set_report_preference(self, interaction: discord.ApplicationContext, preference: str):
...
class AttendanceView(discord.ui.View):
    ...
    async def mark_attendance_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def view_attendance_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def settings_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
...
class EventTypeSelectView(discord.ui.View):
    ...
    def create_event_type_select(self):
        ...
        async def select_callback(interaction: discord.ApplicationContext):
    ...
    async def back_to_sessions(self, interaction: discord.ApplicationContext):
...
class SessionNameModal(discord.ui.Modal):
    def __init__(self, alliance_id, cog):
        super().__init__(title="Attendance Session")
        self.alliance_id = alliance_id
        self.cog = cog
...
class AllianceSelectView(discord.ui.View):
    ...
    async def prev_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        self.page = max(0, self.page - 1)
        self.update_select_menu()
        await interaction.response.edit_message(view=self)

    @discord.ui.button(label="▶️", style=discord.ButtonStyle.secondary, row=1)
    async def next_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def back_to_attendance_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await self.cog.show_attendance_menu(interaction)
...
class EditEventDetailsView(discord.ui.View):
    ...
    async def on_event_type_select(self, interaction: discord.ApplicationContext):
    ...
    async def rename_session_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def edit_date_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def save_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def cancel_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await self.parent_view.update_main_embed(interaction)

    @discord.ui.button(label="🗑️ Delete Event", style=discord.ButtonStyle.danger, row=3)
    async def delete_event_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
...
class EventDateModal(discord.ui.Modal):
    def __init__(self, current_event_date, parent_view):
        super().__init__(title="Edit Event Date")
        self.current_event_date = current_event_date
        self.parent_view = parent_view
...
class RenameSessionModal(discord.ui.Modal):
    def __init__(self, session_id, current_name, parent_view):
        super().__init__(title="Rename Session")
        self.session_id = session_id
...
class ConfirmDeleteView(discord.ui.View):
    ...
    async def confirm_delete(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            ...
            async def back_callback(i: discord.ApplicationContext):
    ...
    async def cancel_delete(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await self.parent_view.parent_view.update_main_embed(interaction)

class PlayerFilterModal(discord.ui.Modal):
    def __init__(self, parent_view):
        super().__init__(title="Filter Players")
        self.parent_view = parent_view
...
class PlayerSelectView(discord.ui.View):
    def __init__(self, players, alliance_name, session_name, cog, alliance_id=None, session_id=None, is_edit=False, page=0, event_type="Other", event_date=None):
        super().__init__(title="Filter Players", timeout=7200)
    ...
    async def show_player_attendance_options(self, interaction: discord.ApplicationContext, player):
        # Handle both dict and tuple formats
        if isinstance(player, dict):
            fid = player['fid']
            nickname = player['nickname']
    ...
    async def filter_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        modal = PlayerFilterModal(self)
        await interaction.response.send_modal(modal)

    @discord.ui.button(label="❌ Clear", style=discord.ButtonStyle.danger, row=1, disabled=True)
    async def clear_filter_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        self.filter_text = ""
        self.page = 0
        self.apply_filter()
        self.update_select_menu()
    ...
    async def edit_event_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def view_summary_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def finish_attendance_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            if not self.selected_players:
                error_embed = discord.Embed(
                    title="❌ No Data",
    ...
    async def back_to_alliance_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await self.cog.show_attendance_menu(interaction)

    async def update_main_embed(self, interaction: discord.ApplicationContext):
    ...
    async def show_summary(self, interaction: discord.ApplicationContext):
...
class AttendanceModal(discord.ui.Modal):
    ...
    async def update_main_embed_with_confirmation(self, interaction: discord.ApplicationContext):
...
class PlayerAttendanceView(discord.ui.View):
    ...
    async def present_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def absent_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def not_recorded_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def mark_attendance_direct_deferred(self, interaction: discord.ApplicationContext, attendance_type: str, points: int, last_attendance: str):
...
class Attendance(commands.Cog):
    ...
    async def show_attendance_menu(self, interaction: discord.ApplicationContext):
    ...
    async def show_alliance_selection_for_marking(self, interaction: discord.ApplicationContext):
    ...
    async def show_session_selection_for_marking(self, interaction: discord.ApplicationContext, alliance_id: int):
    ...
    async def show_attendance_marking(self, interaction: discord.ApplicationContext, alliance_id: int, alliance_name: str, session_name: str, session_id: int = None, is_edit: bool = False, event_type: str = "Other", event_date: datetime = None):
    ...
    async def process_attendance_results(self, interaction: discord.ApplicationContext, selected_players: dict, alliance_name: str, session_name: str, use_defer: bool = True, session_id: int = None, is_edit: bool = False, event_type: str = "Other", event_date: datetime = None, alliance_id: int = None):
...
class SessionSelectView(discord.ui.View):
    ...
    async def new_session_callback(self, interaction: discord.ApplicationContext):
        """Create a new session"""
        await interaction.response.send_modal(SessionNameModal(self.cog, self.alliance_id))

    async def back_button_callback(self, interaction: discord.ApplicationContext):
    ...
    async def on_select(self, interaction: discord.ApplicationContext):
