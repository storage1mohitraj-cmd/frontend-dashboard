...
class ExportFormatSelectView(discord.ui.View):
    ...
    async def format_select(self, interaction: discord.ApplicationContext, select: discord.ui.Select):
...
"""
    ...
    async def process_export(self, interaction: discord.ApplicationContext, format_type: str, records, session_info):
    ...
    async def show_attendance_report(self, interaction: discord.ApplicationContext, alliance_id: int, session_name: str,
    ...
    async def show_matplotlib_report(self, interaction: discord.ApplicationContext, alliance_id: int, session_name: str,
                                   is_preview=False, selected_players=None, session_id=None, marking_view=None):
        ...
        try:
            ...
            if is_preview:
                ...
                async def preview_back_callback(back_interaction: discord.ApplicationContext):
                ...
                async def back_callback(back_interaction: discord.ApplicationContext):
                ...
                async def export_callback(export_interaction: discord.ApplicationContext):
                    session_info = {
    ...
    async def show_text_report(self, interaction: discord.ApplicationContext, alliance_id: int, session_name: str,
                             is_preview=False, selected_players=None, session_id=None, marking_view=None):
    ...
    async def show_session_selection(self, interaction: discord.ApplicationContext, alliance_id: int):
