...
class AutoTranslate(commands.Cog):
    ...
    @discord.slash_command(name="autotranslatecreate", description="Create automatic translation between channels")
    async def autotranslatecreate(self, interaction: discord.ApplicationContext):
    ...
    @discord.slash_command(name="autotranslatelist", description="View all auto-translate configurations")
    async def autotranslatelist(self, interaction: discord.ApplicationContext):
    ...
    @discord.slash_command(name="autotranslatedelete", description="Delete an auto-translate configuration")
    async def autotranslatedelete(self, interaction: discord.ApplicationContext):
    ...
    @discord.slash_command(name="autotranslatetoggle", description="Enable/disable an auto-translate configuration")
    async def autotranslatetoggle(self, interaction: discord.ApplicationContext):
    ...
    @discord.slash_command(name="autotranslateedit", description="Edit an auto-translate configuration")
    async def autotranslateedit(self, interaction: discord.ApplicationContext):
...
class ConfigNameModal(discord.ui.Modal):
    ...
    def __init__(self, cog):
        super().__init__(title="Auto-Translate Configuration")
        self.cog = cog
...
class LanguageSelectionView(discord.ui.View):
    ...
    def __init__(self, cog, config_data):
        super().__init__(title="Auto-Translate Configuration", timeout=300)
        self.cog = cog
...
class SourceChannelSelect(discord.ui.Select):
    def __init__(self, cog, config_data):
        ...
        super().__init__(
            placeholder="Select source channel (or verify current)",
            min_values=1,
            max_values=1,
...
class TargetChannelSelect(discord.ui.Select):
    def __init__(self, cog, config_data):
        self.cog = cog
        self.config_data = config_data
        ...
        super().__init__(
            placeholder="Select target channel (or verify current)",
            min_values=1,
            max_values=1,
            select_type=discord.ComponentType.channel_select,
            channel_types=channel_type,
...
class EditSourceChannelSelect(discord.ui.Select):
    def __init__(self, current_id=None):
        ...
        super().__init__(
            placeholder="Select new source channel (optional)",
            min_values=1,
            max_values=1,
            select_type=discord.ComponentType.channel_select,
            channel_types=channel_type,
    ...
    async def callback(self, interaction: discord.ApplicationContext):
        ...
        self.view.config_data['source_channel'] = channel.id
        await interaction.response.send_message(
            f"✅ Source channel updated to: {channel.mention}",
            ephemeral=True,
            delete_after=2
        )

class EditTargetChannelSelect(discord.ui.Select):
    def __init__(self, current_id=None):
        self.current_id = current_id
        ...
        super().__init__(
            placeholder="Select new target channel (optional)",
            min_values=1,
            max_values=1,
            select_type=discord.ComponentType.channel_select,
            channel_types=channel_type,
    ...
    async def callback(self, interaction: discord.ApplicationContext):
        channel = self.values[0]
        self.view.config_data['target_channel'] = channel.id
        await interaction.response.send_message(
            f"✅ Target channel updated to: {channel.mention}",
            ephemeral=True,
            delete_after=2
        )
...
class OptionsView(discord.ui.View):
    ...
    async def _show_success_message(self, interaction: discord.ApplicationContext, title: str):
