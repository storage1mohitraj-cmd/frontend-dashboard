...
class BackupOperations(commands.Cog):
    ...
    async def show_backup_menu(self, interaction: discord.ApplicationContext):
...
class BackupView(discord.ui.View):
    ...
    async def set_password(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def create_backup(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def view_backups(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def main_menu(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
...
class BackupChoiceView(discord.ui.View):
    ...
    async def send_dm(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def save_local(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        if interaction.user.id != self.user_id:
            await interaction.response.send_message("❌ This is not your menu!", ephemeral=True)
            return
...
class BackupManageView(discord.ui.View):
    ...
    async def clean_backups(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await interaction.response.defer(ephemeral=True)
...
class BackupPasswordModal(discord.ui.Modal):
    def __init__(self, cog):
        super().__init__(title="Set Backup Password")
        self.cog = cog
...
def setup(bot):
    bot.add_cog(BackupOperations(bot))
