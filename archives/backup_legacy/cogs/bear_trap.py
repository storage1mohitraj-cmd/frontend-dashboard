...
class BearTrap(commands.Cog):
    ...
    async def show_bear_trap_menu(self, interaction: discord.ApplicationContext):
        try:
    ...
    async def check_admin(self, interaction: discord.ApplicationContext) -> bool:
        try:
    ...
    async def show_channel_selection(self, interaction: discord.ApplicationContext, start_date, hour, minute, timezone,
...
class TextInputModal(discord.ui.Modal):
    def __init__(self, title, label, placeholder, default_value="", max_length=None, style=discord.InputTextStyle.short):
...
class EmbedEditorView(discord.ui.View):
    ...
    async def add_image(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            modal = TextInputModal(
                title="Image URL",
                label="Image URL",
    ...
    async def add_thumbnail(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            modal = TextInputModal(
                title="Thumbnail URL",
                label="Thumbnail URL",
    ...
    async def confirm(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
...
class MessageTypeView(discord.ui.View):
    ...
    async def embed_message(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            example_time = "30 minutes"
    ...
    async def plain_message(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
...
class MentionTypeView(discord.ui.View):
    ...
    async def everyone_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def member_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def role_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def no_mention_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
...
class BearTrapView(discord.ui.View):
    ...
    async def set_time_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def manage_notification_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        if not await self.cog.check_admin(interaction):
            return
        try:
            ...
            class SearchButton(discord.ui.Button):
                ...
                async def callback(self, interaction: discord.ApplicationContext):
                    class SearchModal(discord.ui.Modal):
                        ...
                        async def on_submit(modal_self, interaction: discord.ApplicationContext):
            ...
            async def select_callback(select_interaction):
                try:
                    ...
                    class DeleteButton(discord.ui.Button):
                        ...
                        async def callback(self, interaction: discord.ApplicationContext):
                            try:
                                ...
                                async def confirm_callback(interaction: discord.ApplicationContext):
                                    try:
                                ...
                                async def cancel_callback(interaction: discord.ApplicationContext):
                                    try:
                                        await interaction.response.edit_message(
                                            content=(
                    ...
                    class EditButton(discord.ui.Button):
                        ...
                        async def callback(self, button_interaction: discord.ApplicationContext):
