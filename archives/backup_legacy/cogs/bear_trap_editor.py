...
class EmbedFieldModal(discord.ui.Modal):
    def __init__(self, parent_view, field_name, label, placeholder, default="", style=discord.InputTextStyle.short,
...
class EmbedDataView(discord.ui.View):
    ...
    async def update_embed_view(self, interaction: discord.ApplicationContext):
    ...
    async def edit_title(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def edit_description(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await interaction.response.send_modal(
            EmbedFieldModal(
                parent_view=self,
    ...
    async def edit_color(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        default_hex = ""
        if self.color:
    ...
    async def edit_mention_message(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await interaction.response.send_modal(
            EmbedFieldModal(
                parent_view=self,
    ...
    async def edit_footer(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await interaction.response.send_modal(
            EmbedFieldModal(
                parent_view=self,
                field_name="footer",
    ...
    async def edit_author(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await interaction.response.send_modal(
            EmbedFieldModal(
                parent_view=self,
                field_name="author",
    ...
    async def edit_image_url(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await interaction.response.send_modal(
            EmbedFieldModal(
                parent_view=self,
    ...
    async def edit_thumbnail_url(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await interaction.response.send_modal(
            EmbedFieldModal(
                parent_view=self,
    ...
    async def notification_setting(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await interaction.response.defer()
...
class PlainEditorView(discord.ui.View):
    ...
    async def description_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        if "EMBED_MESSAGE" in self.description:
            ...
            class DescriptionModal(discord.ui.Modal):
                def __init__(self, parent_view):
                    ...
                    self.description = discord.ui.TextInput(label="Message",
                                                            placeholder="Enter notification message... You can use @tag for mentions and %t or {time} for time",
                                                            style=discord.InputTextStyle.long, required=True,
    ...
    async def edit_channel(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def edit_time(self, interaction: discord.ApplicationContext, button: discord.ui.Button):

        class TimeModal(discord.ui.Modal):
            def __init__(self, parent_view):
                super().__init__(title="Edit Notification Time")
                self.parent_view = parent_view
    ...
    async def edit_repeat(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        ...
        async def send_day_selector(interaction: discord.ApplicationContext, parent_view):
            try:
                await interaction.response.defer()
                ...
                class DaysView(discord.ui.View):
                    ...
                    async def confirm_days(self, interaction: discord.ApplicationContext):
                        await interaction.response.defer()
        ...
        async def send_custom_modal(interaction: discord.ApplicationContext, parent_view):
            class CustomRepeatModal(discord.ui.Modal):
                def __init__(self):
                    super().__init__(title="Edit Repeat Interval")
                    self.parent_view = parent_view
    ...
    async def edit_mention(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        view = discord.ui.View()

        async def mention_callback(mention_interaction: discord.ApplicationContext, mention_type: str):
            ...
            if mention_type == "everyone":
                ...
                async def role_select_callback(select_interaction: discord.ApplicationContext):
                    await select_interaction.response.defer()
                ...
                async def user_select_callback(select_interaction: discord.ApplicationContext):
                    await select_interaction.response.defer()
        ...
        for label, mention_type in [("📢 everyone", "everyone"), ("👥 Select Role", "role"),
            ...
            async def button_callback(inter: discord.ApplicationContext, t=mention_type):
    ...
    async def edit_notification_ping(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        ...
        for label, value in options:
            async def callback(interaction: discord.ApplicationContext, value=value):
                self.notification_type = value
                if value == 6:  # Custom Times button pressed
                    class CustomTimeModal(discord.ui.Modal):
                        def __init__(self, parent_view):
                            super().__init__(title="Enter Custom Notification Times")
                            self.parent_view = parent_view
...
class NotificationEditor(commands.Cog):
    ...
    async def start_edit_process(self, interaction: discord.ApplicationContext, notification_id: int,
...
def setup(bot):
    bot.add_cog(NotificationEditor(bot))
