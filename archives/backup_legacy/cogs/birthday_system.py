...
class BirthdayWishView(discord.ui.View):
    ...
    async def wish_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def gift_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            # Extract user IDs from custom_id
    ...
    async def annoy_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            # Extract user IDs from custom_id
    ...
    async def gif_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            # Extract user IDs from custom_id
