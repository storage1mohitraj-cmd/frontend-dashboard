...
from admin_utils import is_bot_owner, format_furnace_level
try:
    from db.mongo_adapters import mongo_enabled, AdminsAdapter, AlliancesAdapter, ServerAllianceAdapter, AllianceMembersAdapter, RecordsAdapter, AuthSessionsAdapter, PlayerTimezonesAdapter
except Exception:
...
class FurnaceLevelDict:
    """Helper class to replace hardcoded level mappings with unified logic."""
    def get(self, key, default=None):
        return format_furnace_level(key)
...
class BotOperations(commands.Cog):
    ...
    async def on_interaction(self, interaction: discord.ApplicationContext):
        ...
        if custom_id == "set_player_timezone":
            try:
                ...
                class PlayerSelectionView(discord.ui.View):
                    ...
                    async def previous_page(self, button_interaction: discord.ApplicationContext):
                    ...
                    async def next_page(self, button_interaction: discord.ApplicationContext):
                    ...
                    async def search_player(self, search_interaction: discord.ApplicationContext):
                        ...
                        class PlayerSearchModal(discord.ui.Modal):
                            ...
                            async def on_submit(self, modal_interaction: discord.ApplicationContext):
                                ...
                                if len(matches) == 1:
                                    ...
                                    async def timezone_selected(tz_interaction: discord.ApplicationContext):
                    ...
                    async def player_selected(self, select_interaction: discord.ApplicationContext, fid: str, player_name: str):
                        ...
                        async def show_more_timezones(button_interaction: discord.ApplicationContext):
                            ...
                            async def go_back(back_interaction: discord.ApplicationContext):
        ...
        if custom_id == "timezone_view_members":
            try:
                ...
                class LiveClockView(discord.ui.View):
                    ...
                    async def stop_clock(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                    ...
                    async def start_clock(self, button_interaction: discord.ApplicationContext):
                        self.is_running = True
        ...
        if custom_id in ["record_create", "record_add", "record_remove", "record_view", "record_list", "record_rename", "record_delete"]:
            ...
            if custom_id == "record_create":
                class CreateRecordModal(discord.ui.Modal):
            ...
            if custom_id == "record_add":
                ...
                class RecordSelectView(discord.ui.View):
                    ...
                    async def select_callback(self, select_interaction: discord.ApplicationContext):
                        ...
                        class AddMethodView(discord.ui.View):
                            ...
                            async def add_via_fid(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                            ...
                            async def add_from_alliance(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                                ...
                                try:
                                    ...
                                    class MemberSelectView(discord.ui.View):
                                        def __init__(self, members_list, record_name):
                                            ...
                                            # Level mapping for furnace levels
                                            self.level_mapping = FurnaceLevelDict()
                                        ...
                                        async def members_selected(self, select_interaction: discord.ApplicationContext):
                                            # Toggle selection
                                        ...
                                        async def previous_page(self, btn_interaction: discord.ApplicationContext):
                                        ...
                                        async def next_page(self, btn_interaction: discord.ApplicationContext):
                                        ...
                                        async def add_selected_members(self, add_interaction: discord.ApplicationContext):
            ...
            if custom_id == "record_remove":
                ...
                class RecordSelectView(discord.ui.View):
                    ...
                    async def select_all_callback(self, button_interaction: discord.ApplicationContext):
                        ...
                        class SelectRecordForAllView(discord.ui.View):
                            ...
                            async def record_selected(self, select_interaction: discord.ApplicationContext):
                                selected_record = select_interaction.data['values'][0]
                ...
                class RecordSelectView(discord.ui.View):
                    ...
                    async def select_callback(self, select_interaction: discord.ApplicationContext):
                        ...
                        class MemberListView(discord.ui.View):
                            ...
                            async def previous_page(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                                if self.current_page > 0:
                                    self.current_page -= 1
                            ...
                            @discord.ui.button(emoji="➡️", style=discord.ButtonStyle.secondary, row=0)
                            async def next_page(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                                if self.current_page < self.get_total_pages() - 1:
                                    self.current_page += 1
                                    await button_interaction.response.edit_message(embed=self.create_embed(), view=self)
                                else:
                            ...
                            async def toggle_sort(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                                self.sort_order = "asc" if self.sort_order == "desc" else "desc"
                                self.current_page = 0
                                await button_interaction.response.edit_message(embed=self.create_embed(), view=self)

                            @discord.ui.button(label="Profile", emoji="👤", style=discord.ButtonStyle.secondary, row=0)
                            async def view_profile(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                                ...
                                class ProfileSelectView(discord.ui.View):
                                    ...
                                    async def player_selected(self, select_interaction: discord.ApplicationContext):
        ...
        if custom_id.startswith("view_members_"):
            try:
                ...
                class MemberListView(discord.ui.View):
                    ...
                    async def filter_select(self, select_interaction: discord.ApplicationContext, select: discord.ui.Select):
        ...
        if custom_id == "alliance_control_messages":
            try:
                ...
                async def open_callback(button_interaction: discord.ApplicationContext):
                ...
                async def close_callback(button_interaction: discord.ApplicationContext):
            ...
            try:
                ...
                class ServerSelectionView(discord.ui.View):
                    ...
                    async def search_server(self, search_interaction: discord.ApplicationContext):
                    ...
                    async def clear_search(self, clear_interaction: discord.ApplicationContext):
                    ...
                    async def server_selected(self, select_interaction: discord.ApplicationContext):
                        ...
                        async def alliance_select_callback(alliance_interaction: discord.ApplicationContext):
                            try:
                        ...
                        if current_alliance_id:
                            ...
                            async def remove_callback(button_interaction: discord.ApplicationContext):
                                try:
            ...
            try:
                ...
                class ServerSelectionView(discord.ui.View):
                    ...
                    async def server_selected(self, select_interaction: discord.ApplicationContext):
                        ...
                        class SetPasswordModal(discord.ui.Modal):
                            ...
                            def __init__(self, guild_id: int, guild_name: str):
                                super().__init__(title="🔐 Set Member List Password")
                ...
                if custom_id == "assign_alliance":
                    try:
                        with sqlite3.connect('db/settings.sqlite') as settings_db:
                            ...
                            async def admin_callback(admin_interaction: discord.ApplicationContext):
                                try:
                                    ...
                                    async def alliance_callback(alliance_interaction: discord.ApplicationContext):
                                        try:
                    ...
                    try:
                        ...
                        async def admin_callback(select_interaction: discord.ApplicationContext):
                            try:
                                ...
                                async def confirm_callback(button_interaction: discord.ApplicationContext):
                                    try:
                                        if mongo_enabled() and AdminsAdapter:
                                            try:
                                ...
                                async def cancel_callback(button_interaction: discord.ApplicationContext):
            ...
            try:
                with sqlite3.connect('db/settings.sqlite') as settings_db:
                    ...
                    with sqlite3.connect('db/alliance.sqlite') as alliance_db:
                        ...
                        async def select_callback(select_interaction: discord.ApplicationContext):
                            try:
                                ...
                                async def confirm_callback(confirm_interaction: discord.ApplicationContext):
                                    try:
                                ...
                                async def cancel_callback(cancel_interaction: discord.ApplicationContext):
                                    cancel_embed = discord.Embed(
    ...
    async def show_bot_operations_menu(self, interaction: discord.ApplicationContext):
        try:
            embed = discord.Embed(
    ...
    async def confirm_permission_removal(self, admin_id: int, alliance_id: int, confirm_interaction: discord.ApplicationContext):
        try:
            self.settings_cursor.execute("""
    ...
    @discord.slash_command(name="manage", description="Quick access to management operations")
    async def manage(self, interaction: discord.ApplicationContext):
        ...
        try:
            ...
            class ManageAuthModal(discord.ui.Modal):
                password_input = discord.ui.TextInput(
                ...
                def __init__(self, guild_id: int, guild_name: str):
                    super().__init__(title="🛡️ Security Verification")
                    self.guild_id = guild_id
                    self.guild_name = guild_name
            ...
            class ManageAuthView(discord.ui.View):
                ...
                async def authenticate(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
...
class PersistentMemberListView(discord.ui.View):
    ...
    async def filter_select(self, interaction: discord.ApplicationContext, select: discord.ui.Select):
        try:
    ...
    async def view_profile(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            members, alliance_name = await self.fetch_members_and_alliance_name()
...
def setup(bot):
    bot.add_cog(BotOperations(bot, sqlite3.connect('db/settings.sqlite')))
