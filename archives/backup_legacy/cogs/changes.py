...
class Changes(commands.Cog):
    ...
    async def show_alliance_history_menu(self, interaction: discord.ApplicationContext):
        try:
            embed = discord.Embed(
    ...
    async def show_furnace_history(self, interaction: discord.ApplicationContext, fid: int):
        try:
            self.cursor.execute("""
    ...
    async def show_nickname_history(self, interaction: discord.ApplicationContext, fid: int):
        try:
            self.cursor.execute("""
    ...
    async def show_member_list_nickname(self, interaction: discord.ApplicationContext, alliance_id: int):
        try:
            with sqlite3.connect('db/alliance.sqlite') as alliance_db:
                cursor = alliance_db.cursor()
    ...
    async def show_recent_changes(self, interaction: discord.ApplicationContext, alliance_name: str, hours: int):
        try:
            with sqlite3.connect('db/alliance.sqlite') as alliance_db:
                cursor = alliance_db.cursor()
    ...
    async def show_recent_nickname_changes(self, interaction: discord.ApplicationContext, alliance_name: str, hours: int):
        try:
            with sqlite3.connect('db/alliance.sqlite') as alliance_db:
                cursor = alliance_db.cursor()
                cursor.execute("SELECT alliance_id FROM alliance_list WHERE name = ?", (alliance_name))
...
class HistoryView(discord.ui.View):
    ...
    async def furnace_changes_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def member_callback(self, interaction: discord.ApplicationContext, alliance_id: int):
        try:
            with sqlite3.connect('db/users.sqlite') as users_db:
                cursor = users_db.cursor()
                cursor.execute("""
    ...
    async def nickname_changes_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            admin_info = await self.cog.get_admin_info(interaction.user.id)
            if not admin_info:
                await interaction.response.send_message(
    ...
    async def last_hour_callback(self, interaction: discord.ApplicationContext):
        try:
            if not interaction.response.is_done():
    ...
    async def last_day_callback(self, interaction: discord.ApplicationContext):
        try:
            if not interaction.response.is_done():
                await interaction.response.defer()
    ...
    async def custom_time_callback(self, interaction: discord.ApplicationContext):
        try:
...
class MemberListView(discord.ui.View):
    ...
    async def search_callback(self, interaction: discord.ApplicationContext):
...
class FurnaceHistoryFIDSearchModal(discord.ui.Modal):
    def __init__(self, cog):
        super().__init__(title="Search by FID")
        self.cog = cog
...
class NicknameHistoryFIDSearchModal(discord.ui.Modal):
    def __init__(self, cog):
        super().__init__(title="Search by FID")
        self.cog = cog
        self.fid = discord.ui.TextInput(
...
class CustomTimeModal(discord.ui.Modal):
    def __init__(self, cog, alliance_name):
        super().__init__(title="Custom Time Range")
        self.cog = cog
        self.alliance_name = alliance_name
...
class RecentChangesView(discord.ui.View):
    ...
    async def previous_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        self.current_page = max(0, self.current_page - 1)
        self.update_buttons()
