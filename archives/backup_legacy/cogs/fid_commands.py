    ...
    async def on_message(self, message: discord.Message):
        ...
        if content.startswith('!showlist'):
            try:
                ...
                class MagShieldModal(discord.ui.Modal):
                    ...
                    def __init__(self, alliance_id: int, guild_id: int, channel):
                        super().__init__(title="🛡️ MAG SHIELD • Security Verification")
                    ...
                    async def on_submit(self, modal_interaction: discord.ApplicationContext):
                        try:
                            ...
                            class MemberListView(discord.ui.View):
                                ...
                                async def filter_sort(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
                                    # Toggle sort order
                ...
                class ShowListView(discord.ui.View):
                    ...
                    async def enter_password(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
