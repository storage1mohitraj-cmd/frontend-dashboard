...
class GiftOperations(commands.Cog):
    ...
    async def show_ocr_settings(self, interaction: discord.ApplicationContext):
    ...
    async def get_available_alliances(self, interaction: discord.ApplicationContext):
    ...
    async def setup_gift_channel(self, interaction: discord.ApplicationContext):
        ...
        async def alliance_callback(select_interaction: discord.ApplicationContext):
            try:
                ...
                async def channel_select_callback(channel_interaction: discord.ApplicationContext):
                    try:
    ...
    async def show_gift_menu(self, interaction: discord.ApplicationContext):
    ...
    async def create_gift_code(self, interaction: discord.ApplicationContext):
        # Use admin_utils for robust check
    ...
    async def list_gift_codes(self, interaction: discord.ApplicationContext):
    ...
    async def delete_gift_code(self, interaction: discord.ApplicationContext):
        try:
    ...
    async def delete_gift_channel(self, interaction: discord.ApplicationContext):
    ...
    async def delete_gift_channel_for_alliance(self, interaction: discord.ApplicationContext, alliance_id: int):
        ...
        try:
            ...
            async def confirm_removal(button_interaction: discord.ApplicationContext):
                try:
                    self.cursor.execute("DELETE FROM giftcode_channel WHERE alliance_id = ?", (alliance_id))
                    self.conn.commit()
            ...
            async def cancel_removal(button_interaction: discord.ApplicationContext):
                cancel_embed = discord.Embed(
                    title="❌ Removal Cancelled",
    ...
    async def manage_channel_settings(self, interaction: discord.ApplicationContext):
        ...
        async def config_callback(config_interaction: discord.ApplicationContext):
            ...
            async def alliance_select_callback(alliance_interaction: discord.ApplicationContext):
                ...
                async def channel_callback(channel_interaction: discord.ApplicationContext):
                    try:
                        channel_id = int(channel_interaction.data["values"][0])
        ...
        if channel_configs:
            ...
            async def remove_callback(remove_interaction: discord.ApplicationContext):
                ...
                async def remove_select_callback(remove_select_interaction: discord.ApplicationContext):
                    ...
                    async def confirm_remove_callback(confirm_interaction: discord.ApplicationContext):
                        try:
                            self.cursor.execute("DELETE FROM giftcode_channel WHERE alliance_id = ?", (alliance_id))
                            self.conn.commit()
                    ...
                    async def cancel_remove_callback(cancel_interaction: discord.ApplicationContext):
    ...
    async def channel_history_scan(self, interaction: discord.ApplicationContext):
        ...
        async def alliance_select_callback(select_interaction: discord.ApplicationContext):
            alliance_id = int(alliance_select.values[0])
            alliance_name = alliance_names[alliance_id]
            ...
            async def confirm_scan_callback(confirm_interaction: discord.ApplicationContext):
            ...
            async def cancel_scan_callback(cancel_interaction: discord.ApplicationContext):
    ...
    async def setup_giftcode_auto(self, interaction: discord.ApplicationContext):
        # Acknowledge the interaction immediately to avoid timeout/Unknown interaction
        try:
            await interaction.response.defer(ephemeral=True)
        except Exception:
        ...
        async def alliance_callback(select_interaction: discord.ApplicationContext):
            try:
                ...
                async def button_callback(button_interaction: discord.ApplicationContext):
                    try:
...
class DeleteGiftCodeModal(discord.ui.Modal):
    def __init__(self, cog):
        super().__init__(title="Delete Gift Code")
        self.cog = cog
...
class TestFIDModal(discord.ui.Modal):
    def __init__(self, cog):
        super().__init__(title="Change Test FID")
        self.cog = cog
...
class GiftView(discord.ui.View):
    ...
    async def create_gift(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def gift_code_settings_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def list_gift(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def delete_gift_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def use_gift_alliance_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
            ...
            async def alliance_callback(select_interaction: discord.ApplicationContext):
                try:
                    ...
                    async def giftcode_callback(giftcode_interaction: discord.ApplicationContext):
                        try:
    ...
    async def main_menu_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
...
class SettingsMenuView(discord.ui.View):
    ...
    async def channel_management_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def auto_gift_settings_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def channel_history_scan_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def captcha_settings_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await self.cog.show_ocr_settings(interaction)
    ...
    async def back_to_main_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
...
class ClearCacheConfirmView(discord.ui.View):
    ...
    async def confirm_clear(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def cancel_clear(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        cancel_embed = discord.Embed(
            title="❌ Operation Cancelled",
...
class OCRSettingsView(discord.ui.View):
    ...
    async def change_test_fid_button(self, interaction: discord.ApplicationContext):
    ...
    async def enable_ocr_button(self, interaction: discord.ApplicationContext):
        if not self.onnx_available:
            await interaction.response.send_message("❌ Required library (onnxruntime) is not installed or failed to load.", ephemeral=True)
            return
    ...
    async def test_ocr_button(self, interaction: discord.ApplicationContext):
        logger = self.cog.logger
        user_id = interaction.user.id
        current_time = time.time()
    ...
    async def clear_redemption_cache_button(self, interaction: discord.ApplicationContext):
    ...
    async def image_save_select_callback(self, interaction: discord.ApplicationContext):
        if not self.onnx_available:
            await interaction.response.send_message("❌ Required library (onnxruntime) is not installed or failed to load.", ephemeral=True)
            return
...
def setup(bot):
    bot.add_cog(GiftOperations(bot))
