...
class UserFilterModal(discord.ui.Modal):
    def __init__(self, parent_view):
        super().__init__(title="Filter Users")
...
class FilteredUserSelectView(discord.ui.View):
    ...
    async def user_select_callback(self, interaction: discord.ApplicationContext):
    ...
    async def list_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def update_embed(self, interaction: discord.ApplicationContext):
...
class ClearConfirmationView(discord.ui.View):
    ...
    async def confirm_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
...
class ActivitySelectView(discord.ui.View):
    ...
    async def activity_select(self, interaction: discord.ApplicationContext, select: discord.ui.Select):
...
class MinisterSettingsView(discord.ui.View):
    ...
    async def update_names(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def clear_reservations(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def clear_channels(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        # Check if user is global admin
        is_admin, is_global_admin, _ = await self.cog.get_admin_permissions(interaction.user.id)
        if not is_global_admin:
...
class MinisterChannelView(discord.ui.View):
    ...
    async def construction_day(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def research_day(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def troops_training_day(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def channel_setup(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        # Check if user is global admin
        is_admin, is_global_admin, _ = await self.cog.get_admin_permissions(interaction.user.id)
        if not is_global_admin:
    ...
    async def settings(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        await self.cog.show_settings_menu(interaction)
    ...
    async def _handle_activity_selection(self, interaction: discord.ApplicationContext, activity_name: str):
...
class ChannelConfigurationView(discord.ui.View):
    ...
    async def construction_channel(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def research_channel(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def training_channel(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def log_channel(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def _handle_channel_selection(self, interaction: discord.ApplicationContext, channel_context: str, activity_name: str):
        minister_schedule_cog = self.cog.bot.get_cog("MinisterSchedule")
        if not minister_schedule_cog:
            await interaction.response.send_message("❌ Minister Schedule module not found.", ephemeral=True)
            return
...
class TimeSelectView(discord.ui.View):
    ...
    async def clear_reservation_callback(self, interaction: discord.ApplicationContext):
...
class MinisterMenu(commands.Cog):
    ...
    async def show_minister_channel_menu(self, interaction: discord.ApplicationContext):
    ...
    async def show_channel_setup_menu(self, interaction: discord.ApplicationContext):
        embed = discord.Embed(
            title="📝 Channel Setup",
            description=(
                "Configure channels for minister scheduling:\n\n"
    ...
    async def show_filtered_user_select(self, interaction: discord.ApplicationContext, activity_name: str):
    ...
    async def show_current_schedule_list(self, interaction: discord.ApplicationContext, activity_name: str):
    ...
    async def show_filtered_user_select_with_message(self, interaction: discord.ApplicationContext, activity_name: str, message: str, is_error: bool = False):
    ...
    async def update_minister_names(self, interaction: discord.ApplicationContext, activity_name: str):
    ...
    async def show_clear_confirmation(self, interaction: discord.ApplicationContext, activity_name: str):
    ...
    async def show_time_selection(self, interaction: discord.ApplicationContext, activity_name: str, fid: str, current_time: str = None):
    ...
    async def complete_booking(self, interaction: discord.ApplicationContext, activity_name: str, fid: str, selected_time: str):
        try:
    ...
    async def clear_user_reservation(self, interaction: discord.ApplicationContext, activity_name: str, fid: str, current_time: str):
    ...
    async def show_clear_channels_selection(self, interaction: discord.ApplicationContext):
        ...
        class ClearChannelsConfirmView(discord.ui.View):
            ...
            async def select_channels(self, interaction: discord.ApplicationContext, select: discord.ui.Select):
                try:
                    await interaction.response.defer()
    ...
    async def show_settings_menu(self, interaction: discord.ApplicationContext):
    ...
    async def show_activity_selection_for_update(self, interaction: discord.ApplicationContext):
    ...
    async def show_activity_selection_for_clear(self, interaction: discord.ApplicationContext):
