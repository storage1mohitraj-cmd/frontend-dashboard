...
class DatabaseVersionSelect(ui.View):
    ...
    async def v2_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def v3_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        cog = self.bot.get_cog('DatabaseTransfer')
        await interaction.response.defer(ephemeral=True)
...
class DatabaseTransfer(commands.Cog):
    ...
    async def transfer_old_database(self, interaction: discord.ApplicationContext):
    ...
    async def olddatabase(self, interaction: discord.ApplicationContext):
    ...
    async def transfer_v2_data(self, interaction: discord.ApplicationContext, alliance_id: int):
    ...
    async def transfer_v2_database(self, interaction: discord.ApplicationContext):
        ...
        async def alliance_callback(interaction: discord.ApplicationContext):
            await interaction.response.defer(ephemeral=True)
...
def setup(bot):
    bot.add_cog(DatabaseTransfer(bot))
