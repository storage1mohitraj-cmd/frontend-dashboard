...
class ReminderSystem(commands.Cog):
    ...
    async def create_reminder(self, interaction: discord.ApplicationContext, time_str: str, message: str, target_channel: discord.TextChannel,
    ...
    async def list_user_reminders(self, interaction: discord.ApplicationContext):
    ...
    async def delete_user_reminder(self, interaction: discord.ApplicationContext, reminder_id):
    ...
    async def list_all_active_reminders(self, interaction: discord.ApplicationContext):
