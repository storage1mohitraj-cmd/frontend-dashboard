...
class ServerAge(commands.Cog):
    ...
    @discord.slash_command(name="server_age", description="Check your server age and upcoming milestones")
    @command_animation
    async def server_age(self, interaction: discord.ApplicationContext, state_number: int, days: int = None):
