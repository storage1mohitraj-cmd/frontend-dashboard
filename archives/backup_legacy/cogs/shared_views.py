...
class PersistentFeedbackModal(discord.ui.Modal):
    feedback = discord.ui.TextInput(label="Your feedback", style=discord.InputTextStyle.long,
...
class PersistentHelpView(discord.ui.View):
    ...
    async def share_feedback(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
...
class ReminderDashboardView(discord.ui.View):
    ...
    async def list_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def delete_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def tz_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
...
class GiftCodeSettingsView(discord.ui.View):
    ...
    async def channel_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def set_here_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        try:
    ...
    async def manage_codes_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        """
...
class BirthdayDashboardView(discord.ui.View):
    ...
    async def set_channel_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        ...
        try:
            ...
            class ChannelSelectView(discord.ui.View):
                ...
                @discord.ui.channel_select(placeholder="Select birthday wishes channel", channel_types=[discord.ChannelType.text], min_values=1, max_values=1)
                async def channel_select(self, select_interaction: discord.ApplicationContext, select: discord.ui.ChannelSelect):
    ...
    async def set_my_birthday_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        ...
        try:
            ...
            class BirthdayModal(discord.ui.Modal):
                day_input = discord.ui.TextInput(label="Day (1-31)", placeholder="15", style=discord.InputTextStyle.short, required=True, max_length=2)
                month_input = discord.ui.TextInput(label="Month (1-12)", placeholder="6", style=discord.InputTextStyle.short, required=True, max_length=2)
    ...
    async def set_others_birthday_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
        ...
        try:
            class UserSelectView(discord.ui.View):
                ...
                async def user_select(self, select_interaction: discord.ApplicationContext, select: discord.ui.UserSelect):
    ...
    async def remove_birthday_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def upcoming_birthdays_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def my_birthday_button(self, button_interaction: discord.ApplicationContext, button: discord.ui.Button):
