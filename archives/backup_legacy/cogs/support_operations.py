...
class SupportOperations(commands.Cog):
    ...
    async def show_support_menu(self, interaction: discord.ApplicationContext):
    ...
    async def show_support_info(self, interaction: discord.ApplicationContext):
...
class SupportView(discord.ui.View):
    ...
    async def support_request_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def about_project_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
...
def setup(bot):
    bot.add_cog(SupportOperations(bot))
