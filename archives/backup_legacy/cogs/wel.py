...
class GNCommands(commands.Cog):
    ...
    @discord.slash_command(name="channel", description="Learn the ID of a channel.")
    async def channel(self, interaction: discord.ApplicationContext, channel: discord.TextChannel):
