...
class Changes(commands.Cog):
    ...
    async def show_alliance_history_menu(self, interaction: discord.Interaction):
        try:
            embed = discord.Embed(
                title="≡ƒô£ Alliance History Menu",
                description=(
                    "**Available Operations**\n"
                    "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n"
                    "≡ƒöÑ **Furnace Changes**\n"
                    "Γöö View furnace level changes\n\n"
                    "≡ƒô¥ **Nickname Changes**\n"
                    "Γöö View nickname history\n"
                    "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü"
                ),
    ...
    async def show_furnace_history(self, interaction: discord.Interaction, fid: int):
        try:
            ...
            embed = discord.Embed(
                title=f"≡ƒöÑ Furnace Level History",
                description=(
                    f"**Player:** `{nickname}`\n"
                    f"**FID:** `{fid}`\n"
            ...
            for old_level, new_level, change_date in changes:
                ...
                embed.add_field(
                    ...
                    value=f"```{old_level_str} Γ₧£ {new_level_str}```",
                    inline=False
                )
            ...
            await interaction.followup.send(
                "Γ¥î An error occurred while displaying the furnace history.",
                ephemeral=True
            )
    ...
    async def show_nickname_history(self, interaction: discord.Interaction, fid: int):
        try:
            ...
            await interaction.followup.send(
                "Γ¥î An error occurred while displaying the nickname history.",
                ephemeral=True
            )
        ...
        try:
            ...
            if not members:
                await interaction.response.send_message(
                    "Γ¥î No members found in this alliance.",
                    ephemeral=True
                )
                return

            embed = discord.Embed(
                title=f"≡ƒô¥ {alliance_name} - Member List",
                description=(
            ...
            await interaction.response.send_message(
                "Γ¥î An error occurred while displaying the member list.",
                ephemeral=True
            )
    ...
    async def show_recent_changes(self, interaction: discord.Interaction, alliance_name: str, hours: int):
        try:
            ...
            await interaction.followup.send(
                "Γ¥î An error occurred while showing recent changes.",
                ephemeral=True
            )
...
class HistoryView(discord.ui.View):
    ...
    async def furnace_changes_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            if not admin_info:
                await interaction.response.send_message(
                    "Γ¥î You don't have permission to perform this action.",
                    ephemeral=True
                )
                return
            ...
            if not available_alliances[0]:
                await interaction.response.send_message(
                    embed=discord.Embed(
                        title="Γ¥î No Available Alliance",
            ...
            if special_alliances:
                ...
                special_alliance_text += "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n"
                for _, name in special_alliances:
                    special_alliance_text += f"≡ƒö╕ {name}\n"
                special_alliance_text += "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü"

            select_embed = discord.Embed(
                title="≡ƒöÑ Furnace Changes",
                description=(
                    "Select an alliance to view furnace changes:\n\n"
                    "**Permission Details**\n"
                    "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n"
                    f"≡ƒæñ **Access Level:** `{'Global Admin' if admin_info[1] == 1 else 'Server Admin'}`\n"
                    f"≡ƒöì **Access Type:** `{'All Alliances' if admin_info[1] == 1 else 'Server + Special Access'}`\n"
                ...
                try:
                    ...
                    if not select_interaction.response.is_done():
                        await select_interaction.response.send_message(
                            "Γ¥î An error occurred while processing your selection.",
                            ephemeral=True
                        )
                    else:
            ...
            await interaction.response.send_message(
                "Γ¥î An error occurred while processing the request.",
                ephemeral=True
            )
    ...
    async def member_callback(self, interaction: discord.Interaction, alliance_id: int):
        try:
            ...
            embed = discord.Embed(
                title=f"≡ƒöÑ {alliance_name} - Member List",
                description=(
            ...
            if not interaction.response.is_done():
                await interaction.response.send_message(
                    "Γ¥î An error occurred while showing member list.",
                    ephemeral=True
                )
            else:
                await interaction.followup.send(
    ...
    async def nickname_changes_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            select_embed = discord.Embed(
                title="≡ƒô¥ Alliance Selection - Nickname Changes",
                description=(
    ...
    async def show_main_menu(self, interaction: discord.Interaction):
        try:
            ...
            if alliance_cog:
                ...
                await interaction.response.send_message(
                    "Γ¥î An error occurred while returning to the main menu.",
                    ephemeral=True
                )
        except Exception as e:
    ...
    async def custom_time_callback(self, interaction: discord.Interaction):
        try:
            ...
            await interaction.followup.send(
                "Γ¥î An error occurred while showing the time input.",
                ephemeral=True
            )
...
class MemberListView(discord.ui.View):
    ...
    def update_view(self):
        ...
        async def member_callback(interaction):
            try:
                ...
                if not interaction.response.is_done():
                    await interaction.response.send_message(
                        "Γ¥î An error occurred while showing furnace history.",
                        ephemeral=True
                    )
                else:
                    await interaction.followup.send(
    ...
    async def update_page(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            title=f"≡ƒöÑ {self.alliance_name} - Member List",
            description=(
                "Select a member to view furnace history:\n"
                "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n"
...
class FurnaceHistoryFIDSearchModal(discord.ui.Modal, title="Search by FID"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            await interaction.response.send_message(
                "Γ¥î Invalid FID format. Please enter a valid number.",
                ephemeral=True
            )
        except Exception as e:
            ...
            if not interaction.response.is_done():
                await interaction.response.send_message(
                    "Γ¥î An error occurred while searching for the player.",
                    ephemeral=True
                )
            else:
                await interaction.followup.send(
...
class MemberListViewNickname(discord.ui.View):
    ...
    def update_view(self):
        ...
        async def member_callback(interaction):
            try:
                ...
                if not interaction.response.is_done():
                    await interaction.response.send_message(
                        "Γ¥î An error occurred while showing nickname history.",
                        ephemeral=True
                    )
                else:
                    await interaction.followup.send(
    ...
    async def update_page(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            title=f"≡ƒô¥ {self.alliance_name} - Member List",
            description=(
                "Select a member to view nickname history:\n"
                "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n"
                f"Total Members: {len(self.members)}\n"
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            if hours < 1 or hours > 24:
                await interaction.response.send_message(
                    "Γ¥î Please enter a number between 1 and 24.",
                    ephemeral=True
                )
                return
            ...
            await interaction.response.send_message(
                "Γ¥î Please enter a valid number.",
                ephemeral=True
            )
        except Exception as e:
            print(f"Error in CustomTimeModal on_submit: {e}")
            await interaction.response.send_message(
                "Γ¥î An error occurred while processing your request.",
                ephemeral=True
            )
...
class RecentChangesView(discord.ui.View):
    ...
    def get_embed(self):
        embed = discord.Embed(
            title=f"≡ƒöÑ Recent Level Changes - {self.alliance_name}",
            description=(
    ...
    @discord.ui.button(label="Previous", emoji="Γ¼à∩╕Å", style=discord.ButtonStyle.secondary, custom_id="previous")
    async def previous_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.current_page = max(0, self.current_page - 1)
        self.update_buttons()
        await interaction.response.edit_message(embed=self.get_embed(), view=self)

    @discord.ui.button(label="Next", emoji="Γ₧í∩╕Å", style=discord.ButtonStyle.secondary, custom_id="next")
...
class RecentNicknameChangesView(discord.ui.View):
    ...
    def get_embed(self):
        embed = discord.Embed(
            title=f"≡ƒô¥ Recent Nickname Changes - {self.alliance_name}",
            description=(
                f"Showing changes in the last {self.hours} hour(s)\n"
                "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü\n"
                f"Total Changes: {sum(len(chunk) for chunk in self.chunks)}\n"
    ...
    @discord.ui.button(label="Previous", emoji="Γ¼à∩╕Å", style=discord.ButtonStyle.secondary, custom_id="previous_nick_recent")
    async def previous_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.current_page = max(0, self.current_page - 1)
        self.update_buttons()
        await interaction.response.edit_message(embed=self.get_embed(), view=self)

    @discord.ui.button(label="Next", emoji="Γ₧í∩╕Å", style=discord.ButtonStyle.secondary, custom_id="next_nick_recent")
    async def next_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.current_page = min(self.total_pages - 1, self.current_page + 1)
        self.update_buttons()
        await interaction.response.edit_message(embed=self.get_embed(), view=self)
